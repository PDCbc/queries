 ...
 *
 * @param referenceTime {Object} date object used for the reference time
 * @return {String} - The age range string the patient falls within. e.g. '10-19',
 *      at teh given referenceTime
 *      returns null if no age range could be found or there was an error.
 */

function getAgeRangeReference(pt, ranges, referenceTime) {
    ...
    for(var k in ageRanges){
        ...
        if( isAgeReference(pt, ageRanges[k].lower, ageRanges[k].upper, referenceTime)){

 ...
 * Query Title: PDC-958
 * Query Type:  Ratio
 * Description: Number of patients with reported COPD / total number of patients (in age range). 
 *                (patient ages are restricted to 20 - 120 yrs old.)
 */
function map( patient ){
  ...
  * Additional criteria:
  *   - 20 to 120 years old
  *   - has { "ICD9": ["490", "491", "492", "494", "495", "496"]} condition, in last 1000000 years
  */
  function checkNumerator(){
    ...
    //   - Conditions use a regex match, so make sure to preface with '^'!
        ...
        conCodes ={ "ICD9"      :[ "^490",     // COPD: http://www.icd9data.com/2015/Volume1/460-519/490-496/default.htm
                                   "^491",     
                                   "^492",     
                                   "^494",    
                                   "^495",   
    ...
    return isAge( ageMin, ageMax ) && isMatch( conditions );
  }

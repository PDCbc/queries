/**
 * Query Title: PDC-1136_Lab-LDL<=2point6wDiabetes
 * Query Type:  Ratio
 */
function map(patient) {
    ...
    var hl = hasInRangeLab(patient, 'LOINC', '39469-2', false, Number.NEGATIVE_INFINITY, 2.6, 'mmol/L', minDate, maxDate, false);

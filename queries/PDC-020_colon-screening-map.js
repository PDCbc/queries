...
function map(patient) {
    ...
    function checkNumerator() {
        ...
        var now           = new Date(),
            ...
            resCodes_Hc   = {
                "pCLOCD": ["14563-1",   // Hemoglobin.gastrointestinal [Presence] in Stool --1st specimen
                    ...
                    "58453-2"]
            }, // Hemoglobin.gastrointestinal [Mass/​volume] in Stool by Immunologic method
            ...
            resCodes_CS   = {
                "LOINC": ["18746-8",    // Colonoscopy study
                    ...
                    "28027-1"]
            },  // Flexible sigmoidoscopy Study observation

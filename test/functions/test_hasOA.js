function setUp (){
    ...
    var obj = {
        ...
        "birthdate": -25,
        "conditions" : [
            { "codes": { "ICD9": ["715.1"]}, "time": 1263167138, "description": "Condition"}
        ]
    };
    return obj;
}
...
module.exports = {
    ...
    testPatientMultipleConditions : function (){
        ...
        p.conditions[2] = { "codes": { "ICD9": ["715.0"]}, "time": 1263167138, "description": "condition"};
    ...
    testPatientWithCombinedCodeSystems : function (){
        ...
        p.conditions = [];
        p.conditions[0] = { "codes": { "SNOMED-CT": ["123455"], "ICD9" : ["715.1"]}, "time": 1263167138, "description": "condition"};
    ...
    testMultipleOACodes : function(){

        var codes = ["715.1","715.9"]; //correct codes with random sub-codes.
        ...
        if(result === true ){
            ...
            return {result : false, message : "expected true, patient has condition ICD9 code"};

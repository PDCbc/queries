function setUp (){
    ...
    var obj = {
        ...
        "birthdate": -25,
        "conditions" : [
            { "codes": { "ICD9": ["311"]}, "time": 1263167138, "description": "Condition"}
        ]
    };
    return obj;
}
...
module.exports = {
    ...
    testPatientMultipleConditions : function (){
        ...
        p.conditions[2] = { "codes": { "ICD9": ["311"]}, "time": 1263167138, "description": "condition"};
    ...
    testPatientWithCombinedCodeSystems : function (){
        ...
        p.conditions = [];
        p.conditions[0] = { "codes": { "SNOMED-CT": ["123455"], "ICD9" : ["311"]}, "time": 1263167138, "description": "condition"};
    ...
    testAllDepressionCodes : function(){

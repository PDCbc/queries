/*
* Unit tests for the isFrail function
*/
	...
	*/
	...
	testEolPatient: function(){
        ...
        try {
            ...
            if (!hasFrailtyConditions(setUp())) {

                return {result: true, message: "test passed!"}

            } else {

                return {result: false, message: "passing undefined patient to hasFrailtyConditions() should yield false."};
